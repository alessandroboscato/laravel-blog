	...
	<div class="container w-full md:max-w-3xl mx-auto pt-20">
        ...
        <div class="w-full px-4 md:px-6 text-xl text-gray-800 leading-normal" style="font-family:Georgia,serif;">
			...
			<div class="font-sans">
						...
						<input name="title" type="text" class="w-full" id="title" placeholder="{{$post->title}}" required>
			</div>
            <div class="font-sans">
                <p><label for="description">Description</label></p>
                <textarea name="description" class="w-full" id="content" rows="3" placeholder="{{$post->description}}" required></textarea>
			</div>
            <div class="font-sans">
                <label for="content">Content</label>
                <textarea name="content" class="w-full" id="content" rows="3" placeholder="{{$post->content}}" required></textarea>
			</div>
		...
		<div class="flex w-full items-center font-sans px-4 py-12">
			<div class="flex-1 px-2">
				...
				<input name="author" type="text" class="form-control" id="author" placeholder="{{$post->author}}" required>
			</div>
